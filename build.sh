...
clang++ -std=c++23 -fuse-ld=lld -fms-extensions -fms-compatibility --target=i386-windows-msvc -v -o d2d1_p.dll -shared main.obj proxy.obj patcher.obj prop.obj -Wl,-subsystem:windows,-def:d2d1.def
